...
public class LabActivity extends ActionBarActivity {
	...
	public static final String EXTRA_PHOTO_URI = "cn.dennishucd.secondsight.LabActivity.extra.PHOTO_URI";
	public static final String EXTRA_PHOTO_DATA_PATH = "cn.dennishucd.secondsight.LabActivity.extra.PHOTO_DATA_PATH";
	private Uri mUri;
	...
	/*
	 * Show a confirmation dialog. On confirmation, the photo is deleted and the
	 * activity finishes.
	 */
