package cn.dennishucd.secondsight.filters.curve;
...
public class CurveFilter implements Filter {
	...
	public CurveFilter(final double[] vValIn, final double[] vValOut, final double[] rValIn,
			final double[] rValOut, final double[] gValIn, final double[] gValOut,
